...
import vid from '../../assets/chanelly/chanelly gif.webm'
         ...
         <div className="flex flex-col  h-screen">
            ...
            <div className='w-screen h-full flex' >
               <div className='xl:max-w-[35vw]  flex-col content-end' style={{ textAlign: "center", marginLeft: "2.5vw", marginRight: "2rem", flex: 5 }}>
                  <Slideshow>
                     <img src={chanelly_01} width={"100%"} />
                     <img src={chanelly_02} width={"100%"} />
                     <img src={chanelly_03} width={"100%"} />
                     <img src={chanelly_04} width={"100%"} />
                     <img src={chanelly_05} width={"100%"} />
                     <img src={chanelly_06} width={"100%"} />
               ...
               <div className='h-full w-full ml-auto' style={{
                  ...
                  <div style={{ width: "100%", display: "flex", textAlign: 'center' }}>
                     ...
                     <div className='ml-auto '>
                        <svg width="60" height="15" viewBox="0 0 117 25" fill="none" xmlns="http://www.w3.org/2000/svg">
